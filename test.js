...
//  *  5. split: thay đổi dấu "," trong chuỗi
//  */
// console.log(problem);
...
// console.log(problem.replace(/CSS/g, "JavaScript")); // thay doi tat ca chu " HTML" thanh " JavaScript"
...
//  6. unshift: thêm elenmet ở đầu mảng và in ra độ dài mảng
...
// console.log(languages.slice(0, 1)); // cat phan tu dau tien
// console.log(languages);
